  ...
  const handleSubmit = async (e) => {
    ...
    try {
     const response = await api.post("/auth/register", formData);
      ...
      navigate(`/otp-verify/${response.data.otpToken}`);
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-xl text-indigo-600 font-bold  tracking-tight">
            TaskSync
          </h1>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-3  py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                />
              </div>
            </div>
